...
onHandleDelete(e:any){
// console.log("one",e.target.key);
}
  render(){
    return(
      <div>
        ...
        <form >
          ...
          <input type="text" name="todo_text_box" id="todo_text_box" value = {this.state.currentText} onChange = {this.handleChange}/>
          <button onClick = {this.onHandleSubmit}>Add {this.state.items.length} #Item</button>
        </form>
      </div>
    )
  }
